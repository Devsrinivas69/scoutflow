...
- ✅ **Email Verification** — Eazyreach verifies work emails
...
│       └── exports/
├── lib/
│   ├── services/                   # Ocean, Prospeo, Eazyreach, Brevo
...
User → /pipeline → enters domain
  ...
  → Worker: Stage 3 (Eazyreach) → emails verified
